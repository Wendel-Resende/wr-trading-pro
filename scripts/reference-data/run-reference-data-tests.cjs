...
try {
  ...
  run(process.execPath, ['node_modules/typescript/bin/tsc', '-p', 'scripts/reference-data/tsconfig.json']);
  ...
  tempDir = mkdtempSync(join(os.tmpdir(), 'wr-refdata-test-'));
  ...
  run(process.execPath, ['scripts/reference-data/.dist/scripts/reference-data/reference-data-test.js'], testEnv);
} catch (error) {
